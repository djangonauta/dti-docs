...
# 'searchbox.html']``.
#
# html_sidebars = {'**': ['globaltoc.html', 'sourcelink.html', 'searchbox.html', 'versions.html']}


# -- Options for HTMLHelp output ---------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = 'ManuaisoDTI-IFPA'
...
latex_documents = [
    (master_doc, 'manuais.tex', 'Manuais DTI-IFPA',
...
man_pages = [
    (master_doc, 'Manuais DTI-IFPA', 'Manuais DTI-IFPA',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Manuais DTI-IFPA', 'Manuais DTI-IFPA',
     author, 'Manuais DTI-IFPA', 'Manuais DTI-IFPA.',
     'Miscellaneous'),
]
